...
//       //give it set point
//       Math.toRadians(Constants.SAngels[m_shoulder.position]),
//       //send output to motor
//       output->m_shoulder.useOutput(output,Math.toRadians(Constants.SAngels[m_shoulder.position])),
//       //required subsystem
//       m_shoulder);
...
// public Command andThen(Object wait) {
//     return null;
// }
// }